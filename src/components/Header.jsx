      ...
      <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
        <div className="content lg:text-center">
          <div className="btn py-3">
            <button  className=' border-2 border-[#b0aaaa] font-bold text-white bg-[linear-gradient(90deg,#b004b0,#38097a)] p-4 rounded-2xl'>Welcome to Space X</button>
          </div>
          <h1 className='text-white text-5xl font-bold'>Hi! Im astronout</h1>
          ...
          <button className='  text-white text-2xl'>Lets Connect <i className="fa-solid fa-arrow-right text-lg  p-[2px] "></i> </button>
        </div>
